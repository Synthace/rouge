...
module Rouge
  module Lexers
    class Antha < RegexLexer
      title "Antha"
      desc 'The Antha language (http://www.antha-lang.org)'
      tag 'antha'
      aliases 'antha', 'anthalang'
      filenames '*.an'

      mimetypes 'text/x-antha', 'application/x-antha'
      ...
      PREDECLARED_TYPES      = /\b(?:
                               ...
                               | uintptr    | uint       | File
                               | Concentration | LHComponent | Volume
                               | LHPlate | DNASequence | Temperature
                               | Time
      	                       )\b/x
